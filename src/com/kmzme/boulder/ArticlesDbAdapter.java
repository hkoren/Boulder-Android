...
public class ArticlesDbAdapter {
    ...
    public static final String KEY_GUID = "_id";
    ...
    private static final String DATABASE_CREATE =
        "create table articles (_id text primary key, feed_id integer not null,"
        + "title text not null, link text, description text, content text);";
     ...
     */
    public ArticlesDbAdapter open() throws SQLException {
     ...
     */
    public Cursor fetchArticle(String guid) throws SQLException {
     ...
     */
    public boolean updateNote(String guid, String title, String content, String description, Integer feed_id, String link) {
